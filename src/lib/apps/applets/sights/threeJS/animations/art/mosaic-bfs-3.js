...
Scale the parent group according to the following rules
    dt += 2e-1 * delta;
    parentGroup.scale.set(1.5 + Math.sin(dt), 1.5 + Math.sin(dt), 1);
    parentGroup.rotateZ(1e-1 * delta);
*/
