...
function Bubble() {
	...
	this.colorR = p5.random(10, 255);
	this.colorG = p5.random(10, 255);
	this.colorB = p5.random(10, 255);
...
export default {
  	...
  	metadata: {
		active: false,
		address: '/p5#sketches_bubbles_randomly_colored',
		name: 'bubbles-randomly-colored',
		engine: 'p5',
		// category: 'shapes',
		// controllable: true,
		// dynamic: false,
